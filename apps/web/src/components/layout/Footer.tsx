  ...
  return (
    <footer className="bg-navy-800 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white text-sm font-medium px-4 py-2 rounded-lg transition-colors mt-2"
                >
        ...
        <div className="border-t border-navy-600/30 mt-12 pt-8 text-center">
          <p className="text-navy-400 text-sm">
            &copy; {new Date().getFullYear()} VA Turismo Deportivo. Todos los
            derechos reservados.
          </p>
        </div>
      </div>
